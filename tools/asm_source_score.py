...
TARGET_FUNCTIONS = [
    ...
    ("GetEnemyDefLife", 0x1C11C0, 0x90, "entity"),
    ...
    ("boyAI_sub_161BF0",0x161BF0, 0xB8, "entity"),
    ("boyAI_sub_150710",0x150710, 0xB4, "entity"),
    ("boyAI_sub_155F20",0x155F20, 0xB4, "entity"),
    ("boyAI_sub_15D5B0",0x15D5B0, 0xB4, "entity"),
    ("boyAI_sub_15E430",0x15E430, 0xB4, "entity"),
    ("boyAI_sub_144EE8",0x144EE8, 0xB0, "entity"),
    ("boyAI_sub_146DD8",0x146DD8, 0xB0, "entity"),
    ("boyAI_sub_14CEF4",0x14CEF4, 0xB0, "entity"),
    ("boyAI_sub_14FE10",0x14FE10, 0xB0, "entity"),
    ("boyAI_sub_157028",0x157028, 0xB0, "entity"),
    ("boyAI_sub_157918",0x157918, 0xB0, "entity"),
    ("boyAI_sub_157F94",0x157F94, 0xB0, "entity"),
    ("boyAI_sub_15DFB8",0x15DFB8, 0xB0, "entity"),
    ("boyAI_sub_157DF8",0x157DF8, 0xAC, "entity"),
    ("boyAI_sub_15E2D4",0x15E2D4, 0xAC, "entity"),
    ("boyAI_sub_15E438",0x15E438, 0xAC, "entity"),
    ("boyAI_sub_146DE0",0x146DE0, 0xA8, "entity"),
    ("boyAI_sub_14D088",0x14D088, 0xA8, "entity"),
    ("boyAI_sub_150720",0x150720, 0xA8, "entity"),
    ("boyAI_sub_150970",0x150970, 0xA8, "entity"),
    ("boyAI_sub_15E868",0x15E868, 0xA4, "entity"),
    ("boyAI_sub_14C338",0x14C338, 0xA0, "entity"),
    ("boyAI_sub_14C630",0x14C630, 0xA0, "entity"),
    ("boyAI_sub_156A6C",0x156A6C, 0xA0, "entity"),
    ("boyAI_sub_1572E8",0x1572E8, 0xA0, "entity"),
    ("boyAI_sub_145088",0x145088, 0x9C, "entity"),
    ("boyAI_sub_15C5C0",0x15C5C0, 0x9C, "entity"),
    ("boyAI_sub_150BC4",0x150BC4, 0x98, "entity"),
    ("boyAI_sub_14D180",0x14D180, 0x94, "entity"),
    ("boyAI_sub_15D228",0x15D228, 0x90, "entity"),
    ("boyAI_sub_14B390",0x14B390, 0x8C, "entity"),
    ("boyAI_sub_15613C",0x15613C, 0x8C, "entity"),
    ("boyAI_sub_157B28",0x157B28, 0x88, "entity"),
    ("boyAI_sub_159B44",0x159B44, 0x88, "entity"),
    ("boyAI_sub_15C2B8",0x15C2B8, 0x88, "entity"),
    ("boyAI_sub_149E90",0x149E90, 0x84, "entity"),
    ("boyAI_sub_14B54C",0x14B54C, 0x84, "entity"),
    ("boyAI_sub_1575B4",0x1575B4, 0x84, "entity"),
    ("boyAI_sub_145E88",0x145E88, 0x80, "entity"),
    ("boyAI_sub_144EB4",0x144EB4, 0x7C, "entity"),
    ("boyAI_sub_14B548",0x14B548, 0x7C, "entity"),
    ("boyAI_sub_157818",0x157818, 0x7C, "entity"),
    ("boyAI_sub_15D974",0x15D974, 0x7C, "entity"),
    ("boyAI_sub_1561B0",0x1561B0, 0x78, "entity"),
    ("boyAI_sub_15697C",0x15697C, 0x78, "entity"),
    ("boyAI_sub_14D148",0x14D148, 0x74, "entity"),
    ("boyAI_sub_150C94",0x150C94, 0x74, "entity"),
    ("boyAI_sub_14B388",0x14B388, 0x70, "entity"),
    ("boyAI_sub_153E88",0x153E88, 0xA8, "entity"),
    ("boyAI_sub_15DFC0",0x15DFC0, 0xA8, "entity"),
    ("boyAI_sub_15E91C",0x15E91C, 0xA8, "entity"),
    ("boyAI_sub_147B30",0x147B30, 0xA4, "entity"),
    ("boyAI_sub_149B58",0x149B58, 0xA4, "entity"),
    ("boyAI_sub_14DBBC",0x14DBBC, 0xA4, "entity"),
    ("boyAI_sub_1585B8",0x1585B8, 0xA4, "entity"),
    ("boyAI_sub_15DCAC",0x15DCAC, 0xA4, "entity"),
    ("boyAI_sub_15E9C0",0x15E9C0, 0xA4, "entity"),
    ("boyAI_sub_15F018",0x15F018, 0xA4, "entity"),
    ("boyAI_sub_14D090",0x14D090, 0xA0, "entity"),
    ("boyAI_sub_14E710",0x14E710, 0xA0, "entity"),
    ("boyAI_sub_14F104",0x14F104, 0xA0, "entity"),
    ("boyAI_sub_15197C",0x15197C, 0xA0, "entity"),
    ("boyAI_sub_145060",0x145060, 0x9C, "entity"),
    ("boyAI_sub_15085C",0x15085C, 0x98, "entity"),
    ("boyAI_sub_15E9A8",0x15E9A8, 0x98, "entity"),
    ("boyAI_sub_14B6A0",0x14B6A0, 0x94, "entity"),
    ("boyAI_sub_158F18",0x158F18, 0x90, "entity"),
    ("boyAI_sub_15C534",0x15C534, 0x90, "entity"),
    ("boyAI_sub_1518CC",0x1518CC, 0x1C, "entity"),
    ("boyAI_sub_14BC78",0x14BC78, 0x18, "entity"),
    ("boyAI_sub_14C100",0x14C100, 0x4, "entity"),
    ("boyAI_sub_156A68",0x156A68, 0x4, "entity"),
    ("boyAI_sub_14E778",0x14E778, 0x10, "entity"),
    ("boyAI_sub_15D060",0x15D060, 0x8, "entity"),
    ("boyAI_sub_144EE4",0x144EE4, 0x4, "entity"),
    ("boyAI_sub_14FE0C",0x14FE0C, 0x4, "entity"),
    ("boyAI_sub_150498",0x150498, 0x40, "entity"),
    ("boyAI_sub_14C05C",0x14C05C, 0x24, "entity"),
    ("boyAI_sub_153E90",0x153E90, 0xA0, "entity"),
    ("boyAI_sub_1624A0",0x1624A0, 0xA0, "entity"),
    ("boyAI_sub_147B38",0x147B38, 0x9C, "entity"),
    ("boyAI_sub_149B60",0x149B60, 0x9C, "entity"),
    ("boyAI_sub_14BF8C",0x14BF8C, 0x9C, "entity"),
    ("boyAI_sub_14DB24",0x14DB24, 0x9C, "entity"),
    ("boyAI_sub_14E7AC",0x14E7AC, 0x9C, "entity"),
    ("boyAI_sub_14F098",0x14F098, 0x9C, "entity"),
    ("boyAI_sub_151A60",0x151A60, 0x9C, "entity"),
    ("boyAI_sub_15368C",0x15368C, 0x98, "entity"),
    ("boyAI_sub_15D048",0x15D048, 0x98, "entity"),
    ("boyAI_sub_14BF90",0x14BF90, 0x94, "entity"),
    ("boyAI_sub_14D4F4",0x14D4F4, 0x94, "entity"),
    ("boyAI_sub_156E88",0x156E88, 0x94, "entity"),
    ("boyAI_sub_144290",0x144290, 0x90, "entity"),
    ("boyAI_sub_146178",0x146178, 0x90, "entity"),
    ("boyAI_sub_14D11C",0x14D11C, 0x90, "entity"),
    ("boyAI_sub_150CC0",0x150CC0, 0x90, "entity"),
    ("boyAI_sub_14B2EC",0x14B2EC, 0x8C, "entity"),
    ("boyAI_sub_14B5B0",0x14B5B0, 0x88, "entity"),
    ("boyAI_sub_14D044",0x14D044, 0x88, "entity"),
    ("boyAI_sub_1502A8",0x1502A8, 0x88, "entity"),
    ("boyAI_sub_1502C8",0x1502C8, 0x88, "entity"),
    ("boyAI_sub_1535D4",0x1535D4, 0x88, "entity"),
    ("boyAI_sub_14B09C",0x14B09C, 0x84, "entity"),
    ("boyAI_sub_14D17C",0x14D17C, 0x84, "entity"),
    ("boyAI_sub_156A5C",0x156A5C, 0x84, "entity"),
    ("boyAI_sub_156B30",0x156B30, 0x84, "entity"),
    ("boyAI_sub_157F88",0x157F88, 0x80, "entity"),
    ("boyAI_sub_149E8C",0x149E8C, 0x4, "entity"),
    ("boyAI_sub_149F1C",0x149F1C, 0x4, "entity"),
    ("boyAI_sub_150BFC",0x150BFC, 0x4, "entity"),
    ("boyAI_sub_157814",0x157814, 0x8, "entity"),
    ("boyAI_sub_157B24",0x157B24, 0x4, "entity"),
    ("boyAI_sub_14B340",0x14B340, 0x4, "entity"),
    ("boyAI_sub_1574CC",0x1574CC, 0x4, "entity"),
    ("boyAI_sub_1596A8",0x1596A8, 0x8, "entity"),
    ("boyAI_sub_159A7C",0x159A7C, 0x4, "entity"),
    ("boyAI_sub_15C5C8",0x15C5C8, 0x4, "entity"),
    ("boyAI_sub_15C990",0x15C990, 0x4, "entity"),
    ("boyAI_sub_15D224",0x15D224, 0x4, "entity"),
    ("boyAI_sub_15DE1C",0x15DE1C, 0x4, "entity"),
    ("boyAI_sub_15DFBC",0x15DFBC, 0x4, "entity"),
    ("boyAI_sub_15E2D0",0x15E2D0, 0x4, "entity"),
    ("boyAI_sub_15E42C",0x15E42C, 0x4, "entity"),
    ("boyAI_sub_15E87C",0x15E87C, 0x4, "entity"),
    ("boyAI_sub_15F014",0x15F014, 0x4, "entity"),
    ("boyAI_sub_149F24",0x149F24, 0x4, "entity"),
